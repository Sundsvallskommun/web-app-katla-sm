import { mockManualEditStakeholder, mockStakeholder } from 'cypress/fixtures/mockStakeholder';
...
export const manuallyEditStakeholder = () => {
  cy.get('[data-cy="manual-person-modal"]').should('exist');
  ...
  //PersonNumber
  cy.get('[data-cy="modal-personNumber-input"]').should('have.value', Cypress.env('mockHyphenPersonNumber'));

  //Name
  cy.get('[data-cy="modal-firstName-input"]').should('have.value', mockStakeholder.firstName).clear();
  cy.get('[data-cy="modal-add-person-button"]').should('exist').click();
  ...
  cy.get('[data-cy="firstName-input-error"]').should('not.exist');
  cy.get('[data-cy="modal-lastName-input"]').should('have.value', mockStakeholder.lastName).clear();
  cy.get('[data-cy="modal-add-person-button"]').should('exist').click();
  ...
  //Phone
  cy.get('[data-cy="modal-phone-input"]').should('have.value', Cypress.env('mockCountryCodePhoneNumber')).type('Testsson');
  cy.get('[data-cy="modal-add-person-button"]').should('exist').click();
  cy.get('[data-cy="modal-phone-input-error"]').should('be.visible');
  cy.get('[data-cy="modal-phone-input"]').clear().type(Cypress.env('mockPhoneNumber'));
  cy.get('[data-cy="modal-phone-input-error"]').should('not.exist');
  ...
  //Address
  cy.get('[data-cy="modal-address-input"]').should('have.value', mockStakeholder.address).clear().type(mockManualEditStakeholder.address || '');
  cy.get('[data-cy="modal-careOf-input"]').should('have.value', mockStakeholder.careOf).clear().type(mockManualEditStakeholder.careOf || '');
  cy.get('[data-cy="modal-zipCode-input"]').should('have.value', mockStakeholder.zipCode).clear().type(mockManualEditStakeholder.zipCode || '');
  cy.get('[data-cy="modal-city-input"]').should('have.value', mockStakeholder.city).clear().type(mockManualEditStakeholder.city || '');
};
