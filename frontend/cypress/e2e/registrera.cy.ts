...
import { addStakeholder, manuallyAddStakeholder, manuallyEditStakeholder } from 'cypress/utils/stakeholder';
    ...
    cy.get('.sk-disclosure-header-title')
      ...
      .within(() => {
        ...
        cy.get('[data-cy="stakeholder-card"]')
          ...
          .should('contain.text', 'PLACEHOLDER TITEL');
        cy.get('[data-cy="stakeholder-card"]')
          .find('[data-cy="stakeholder-department"]')
          .should('contain.text', 'PLACEHOLDER AVDELNING');
