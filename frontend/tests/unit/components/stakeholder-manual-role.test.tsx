...
describe('manually added stakeholder', () => {
  it('marks contact details as optional while names remain required', () => {
    ...
    expect(screen.getByRole('textbox', { name: /stakeholder.emailOptional/ })).not.toBeRequired();
    expect(screen.getByRole('textbox', { name: /stakeholder.phoneOptional/ })).not.toBeRequired();
