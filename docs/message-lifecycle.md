...
Hooken `useConversationMessages` äger hämtningar och läskvitton. Användaren kan hämta äldre meddelanden och uppdatera manuellt. Historiken uppdateras också vid fokus, återanslutning, återgång till synlig sida och var 30:e sekund när sidan är synlig. Vid uppdatering hämtas minst de redan öppnade sidorna igen. Om nya meddelanden har flyttat tidigare visad historik längre bak fortsätter hämtningen tills den täcks. Sista sidan avslutar alltid hämtningen, även om något tidigare meddelande har tagits bort. Begäran om äldre meddelanden hämtar ytterligare en sida efter att den tidigare historiken täckts. Dubbletter identifieras med både samtals-ID och meddelande-ID.

Historikhämtningar överlappar inte. Ett eget skickande köar en ny uppdatering om en hämtning redan pågår. Misslyckad uppdatering behåller tidigare historik med ett felmeddelande.

Läskvitton har en separat livscykel per ärende. Historikhämtningar och kvitton för andra samtal kan fortsätta medan ett kvitto väntar. En uppdatering av historiken avbryter inte pågående kvitton. Samma meddelande kvitteras inte igen medan dess anrop pågår eller efter en lyckad kvittens; misslyckade kvitton provas vid nästa uppdatering. Dolda sidor skickar inte nya läskvitton. Byte av ärende och avmontering avbryter både historikhämtningar och läskvitton och avvisar sena svar.
